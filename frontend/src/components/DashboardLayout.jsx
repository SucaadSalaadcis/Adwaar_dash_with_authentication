    ...
    return (
        <>
            <div>
                        ...
                        <ul className="menu bg-neutral text-accent min-h-full w-80 p-4">
                            ...
                            <div>
                                ...
                                <div className={`${open ? "hidden" : "block"}  text-lg mt-2 ml-14 text-blue-50 `}>
                                    <Link to={'/dashboard/formElements'}>{t('formEle')}</Link>
                                    <br />
                                    <Link to={'/dashboard/formLayout'}>{t('formLa')}</Link>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className={`${open2 ? "hidden" : "block"}  text-lg mt-2 ml-14 text-blue-50 `}>
                                    <Link to={'/dashboard/charts'} >{t('basicChart')}</Link>
                                    <p>{t('advancedChart')}</p>
                                </div>
                            </div>
                            ...
                            <div className='mt- ml-1'>
                                ...
                                <p className='flex mt-3'><IoLogOut className='text-xl ml-5 mt-1' /> <span className='pl-2 text-lg cursor-pointer' onClick={handleLogout} >Logout</span></p>
                            </div>
                            <hr />
                ...
                {/* footer */}
                <footer className="footer footer-center bg-neutral text-base-content p-4 mt-3  ">
                    <aside className='text-white'>
                        <p>Copyright © {new Date().getFullYear()} - All right reserved by Adwaar Tech</p>
                    </aside>
                </footer>
